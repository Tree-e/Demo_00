...
public class Eliet_bulletpool : MonoBehaviour
{
    public static Eliet_bulletpool eliet_Bulletpool;
    ...
    public void Awake()
    {
        eliet_Bulletpool = this;
        bulletPre.transform.localScale = new Vector3(3, 3, 3);
    }
    private void Start()
    {
